...
/**
 * Diese Klasse stellt die Basis f�r die Modellkalssen dar und biete �ber 
 * <code>java.beans.PropertyChangeListener</code> ein Observer Pattern 
 * um �nderungen an den Modellen an die beteiligten EditParts 
 * 
 * Gleichzeitig verf�gt das ModelObjekt �ber das PropertyChangeListener Interface
 * und reagiert so selbst auf Property�nderungen. Diese werden dann per Default einfach
 * an die registireten Listener weitergegeben. Somit wird ein Event in einem hirachrischen
 * Dom�nen Modell "nach oben durchgereicht"
 * 
 * @author Ralph Soika
 *
 */ 
abstract public class ModelObject implements Serializable, PropertyChangeListener, IPropertySource {
	...
	/**
	 * Die Klasse registriert sich selbst als PropertyChangeListener 
	 * und leitet entsprechende Events weiter. Somit kann ein Hirarchisches
	 * Dom�nenModell aufgeabut werden.
	 */
	 ...
	 * The Method fires an event to inform other classes about the change
	 */
